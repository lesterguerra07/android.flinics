 ...
 */
public class SocialProfileFragment extends Fragment implements IWizardAction {

    private WizardViewModel wizardViewModel;
    private OnFragmentInteractionListener mListener;

    // UI Elements
    protected EditText etSocialProfile;
    ...
    public void displayInfo(ClinicHistoryModel data) {
        etSocialProfile.setText(data.getLastData(HistoryUtil.socialProfile.value).value);
    }

    @Override
    public void saveInfo() {
        wizardViewModel.setSocialProfile(etSocialProfile.getText().toString());
    }

    @Override
    public void initComponents(View view) {
        etSocialProfile = view.findViewById(R.id.socialProfile_EText);
